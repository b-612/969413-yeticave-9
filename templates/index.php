            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        ...
                        <div class="lot__timer timer <?php echo(is_little_time(seconds_before_the_end (strtotime('now')))) ?>">
                            <?php echo(time_before_the_end(seconds_before_the_end(strtotime('now')))) ?>
                        </div>
                    </div>
                </div>
            </li>
